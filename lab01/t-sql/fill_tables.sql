...
ALTER TABLE KOCURY NOCHECK CONSTRAINT fk_nr_bandy;
ALTER TABLE KOCURY NOCHECK CONSTRAINT fk_szef;
...
ALTER TABLE KOCURY CHECK CONSTRAINT fk_nr_bandy;
ALTER TABLE KOCURY CHECK CONSTRAINT fk_szef;
